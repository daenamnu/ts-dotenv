...
exports.parseDurationToMilliseconds = parseDurationToMilliseconds;
 ...
 */
function parseDurationToSeconds(input, fallback, options = {}) {
 ...
 * - Milliseconds: "ms", "millisecond", "milliseconds"
 */
function parseDurationToMilliseconds(input, fallback, options = {}) {
    var _a, _b;
    ...
    const millisecondsPerMonth = (_a = options.millisecondsPerMonth) !== null && _a !== void 0 ? _a : 30 * MILLISECONDS_IN_DAY;
    const millisecondsPerYear = (_b = options.millisecondsPerYear) !== null && _b !== void 0 ? _b : 365 * MILLISECONDS_IN_DAY;
...
function unitToMilliseconds(unit, value, ctx) {
    switch (unit) {
        // years
        case "y":
        case "yr":
